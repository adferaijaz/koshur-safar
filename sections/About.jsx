  ...
  return (
    ...
    z-10`}>
      ...
      ${styles.flexCenter} flex-col`}>
        <TypingText title='| About KOSHUR SAFAR |' textStyle='text-center' />
        <TypingText title='Your requirement is our commitment ' textStyle='text-center' />
        <motion.p
        ...
        >
          At
        <span className="font-extrabold text-white"> Koshur Safar,</span>
